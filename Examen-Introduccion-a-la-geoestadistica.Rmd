...
# Convertir el objeto SpatialPointsDataFrame a SpatialPixels para estimar
# el número de filas y columnas de la grilla de puntos y así crear una 
# matriz espacial de vecinos ponderada
...
histCookDistC2 <- hist(moranPlotC2$infmat[ptosInfC2,"cook.d"], seq(0, 0.1, 0.0025), 
     col = "black", border = "white", 
     xlab = "Distancias de Cook", ylab = "Frecuencia", 
...
# Plot C1
spplot(datosRindeMaiz, zcol = c("ajusteC1.M1", "ajusteC1.M1.SinOut"), 
...
# Plot C2
spplot(datosRindeMaiz, zcol = c("ajusteC2.M1", "ajusteC2.M1.SinOut"), 
       names.attr = c("Modelo con outliers", "Modelo sin outliers"), colorkey = TRUE)
...
# Crear variograma experimental - C1
varModC1 <- variogram(object = )

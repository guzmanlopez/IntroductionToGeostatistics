...
```{r, fig.height=6, fig.width=8, message=TRUE, warning=FALSE}
...
Se observó que el valor de predicción global ($RMSE$) fue mejor para la C2 que para la C1. Sin embargo, se observó una buena predicción para las dos campañas como resumen los indicadores según el valor esperado en la tabla que se imprime más abajo.

```{r, fig.height=10, fig.width=12, message=TRUE, warning=FALSE}

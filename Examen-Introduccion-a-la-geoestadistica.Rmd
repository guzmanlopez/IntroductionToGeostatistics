...
Para cuantificar la relación entre las variables que presentaron tendencia se utilizó el coeficiente de correlación de Pearson.
...
# Rendimiento maíz vs Longitud
cor(x = datosRindeMaiz@coords[!NAs,"Long"], y = datosRindeMaiz@data$maizC1[!NAs], method = "pearson")
cor(x = datosRindeMaiz@coords[,"Long"], y = datosRindeMaiz@data$maizC2, method = "pearson")

# Rendimiento maíz vs Latitud
cor(x = datosRindeMaiz@coords[!NAs,"Lat"], y = datosRindeMaiz@data$maizC1[!NAs], method = "pearson")
cor(x = datosRindeMaiz@coords[,"Lat"], y = datosRindeMaiz@data$maizC2, method = "pearson")

# Rendimiento maíz vs Elevación
cor(x = datosRindeMaiz@data$Elev[!NAs], y = datosRindeMaiz@data$maizC1[!NAs], method = "pearson")
cor(x = datosRindeMaiz@data$Elev, y = datosRindeMaiz@data$maizC2, method = "pearson")

# Rendimiento maíz vs Profundidad de la napa
cor(x = datosRindeMaiz@data$NapaDicC1[!NAs], y = datosRindeMaiz@data$maizC1[!NAs], method = "pearson")
cor(x = datosRindeMaiz@data$NapaDicC2, y = datosRindeMaiz@data$maizC2, method = "pearson")

# Profundidad de la napa vs Elevación
cor(x = datosRindeMaiz@data$NapaDicC1[!NAs], y = datosRindeMaiz@data$Elev[!NAs], method = "pearson")
cor(x = datosRindeMaiz@data$NapaDicC2, y = datosRindeMaiz@data$Elev, method = "pearson")

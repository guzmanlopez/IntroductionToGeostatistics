...
Se definió considerar como valores atípicos aquellos puntos con una distancia de Cook mayores a 0.02. 
...
# Plot C1
spplot(datosRindeMaiz, zcol = c("resAjusteC1.M1", "resAjusteC1.M1.SinOut"), 
       names.attr = c("Modelo con outliers", "Modelo sin outliers"), colorkey = TRUE)
...
# Plot C2
spplot(datosRindeMaiz, zcol = c("resAjusteC2.M1", "resAjusteC2.M1.SinOut"), 
       names.attr = c("Modelo con outliers", "Modelo sin outliers"), colorkey = TRUE)
...
# Plotear variograma 
plot(varOmniC1, xlab = "distancia", ylab = "semivarianza", main = "C1")
...
# Plotear variograma 
plot(varOmniC2, xlab = "distancia", ylab = "semivarianza", main = "C2")
...
# Plotear variograma 
plot(varDirC1, xlab = "distancia", ylab = "semivarianza", main = "C1")
...
# Plotear variograma 
plot(varDirC2, xlab = "distancia", ylab = "semivarianza", main = "C2")
